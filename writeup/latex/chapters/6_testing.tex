...
\begin{landscape}
	...
	\begin{tabularx}{\hsize}{lXXXr}
		...
		& \includegraphics[width=8cm]{tests/f12} & Partial\footnote{\label{fn:discuss}Discussed in Section~\ref{subsec:requirementresults}} \\
		\midrule
		...
		& \includegraphics[width=8cm]{tests/f13} & Yes \\
		\midrule
		...
		& \includegraphics[width=8cm]{tests/f18} & Partial \textsuperscript{\ref{fn:discuss}} \\
		\midrule
